 ...
 */
public class Noise implements IFunction1D, IFunction2D, IFunction3D 
{
	 ...
	 */
	public static float[] findRange(IFunction1D f, float[] minmax) 
	{
		if (minmax == null)
		{
			minmax = new float[2];
	 ...
	 * normalising the function.
	 */
	public static float[] findRange(IFunction2D f, float[] minmax) 
	{
		if (minmax == null)
		{
			minmax = new float[2];
