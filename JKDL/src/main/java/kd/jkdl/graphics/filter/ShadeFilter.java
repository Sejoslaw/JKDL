...
import main.java.kd.jkdl.math.Color4f;
import main.java.kd.jkdl.math.IFunction2D;
import main.java.kd.jkdl.math.ImageFunction2D;
import main.java.kd.jkdl.math.Vector3f;
...
public class ShadeFilter extends WholeImageFilter 
{
	...
	protected int colorSource = COLORS_FROM_IMAGE;
	private int bumpSource = BUMPS_FROM_IMAGE;
	private IFunction2D bumpFunction;
	...
	protected Color4f shadedColor;
	protected Color4f diffuse_color;
	protected Color4f specular_color;
	...
	public void setBumpFunction(IFunction2D bumpFunction) 
	{
		this.bumpFunction = bumpFunction;
	}

	public IFunction2D getBumpFunction() 
	{
		return bumpFunction;
	}
